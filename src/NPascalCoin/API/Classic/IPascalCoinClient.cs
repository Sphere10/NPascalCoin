...
namespace NPascalCoin.API.Classic {
	public interface IPascalCoinClient {
		...
		Account GetAccount(uint account);
		...
		/// <returns></returns>
		Account[] FindAccounts(string name, uint? type = null, uint? status = null, uint? start = null, uint? max = null);
		...
		Account[] GetWalletAccounts(string enc_pubkey = null, string b58_pubkey = null, int? start = null, int? max = null);
		...
		PublicKey GetWalletPubKey(string enc_pubkey = null, string b58_pubkey = null);
		...
		PublicKey[] GetWalletPubKeys(int? start = null, int? max = null);
		...
		/// <returns></returns>
		Block[] GetBlocks(uint? last = null, int? start = null, int? end = null);
		...
		Operation GetBlockOperation(uint block, uint opblock);
		...
		Operation[] GetBlockOperations(uint block, int? start = null, int? max = null);
		...
		Operation[] GetAccountOperations(uint account, int? depth = null, int? start = null, int? max = null);
		...
		Operation[] GetPendings(int? start = null, int? max = null);
		...
		Operation ChangeAccountInfo(uint account_target, uint account_signer, string new_enc_pubkey, string new_b58_pubkey, string new_name, ushort? new_type, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null);
		...
		Operation SendTo(uint sender, uint target, decimal amount, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null);
		...
		/// <remarks>Only one or none of new_b58_pubkey, new_enc_pubkey should be used. Populating both will result in an error.</remarks>
		/// <returns>If operation is successfull will return a JSON Object in "Operation Object" format.</returns>
		Operation ChangeKey(uint account, uint account_signer, string new_enc_pubkey, string new_b58_pubkey, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null);
		...
		Operation[] ChangeKeys(string accounts, string new_enc_pubkey, string new_b58_pubkey, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null);
		...
		/// <remarks>Only one or none of new_b58_pubkey, new_enc_pubkey should be used. Populating both will result in an error.</remarks>
		/// <returns>If operation is successfull will return a JSON Object in "Operation Object" format.</returns>
		Operation ListAccountForSale(uint account_target, uint account_signer, decimal price, uint seller_account, string new_b58_pubkey, string new_enc_pubkey, uint locked_until_block, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null);
		...
		/// <param name="pwd">Used to encrypt payload with aes as a payload_method. If none equals to empty password</param>
		/// <returns>If operation is successfull will return a JSON Object in "Operation Object" format.</returns>
		Operation DelistAccountForSale(uint account_target, uint account_signer, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null);
		...
		/// <param name="pwd">Used to encrypt payload with aes as a payload_method. If none equals to empty password</param>
		/// <returns>If operation is successfull will return a JSON Object in "Operation Object" format.</returns>
		Operation BuyAccount(uint buyer_account, uint account_to_purchase, decimal price, uint seller_account, string new_b58_pubkey, string new_enc_pubkey, decimal amount, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null);
		...
		/// <returns>Returns a Raw Operations Object</returns>
		RawOperation SignSendTo(uint sender, uint target, string sender_enc_pubkey, string sender_b58_pubkey, string target_enc_pubkey, string target_b58_pubkey, uint last_n_operation, decimal amount, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null, string rawoperations = null);
		...
		/// <returns>Returns a Raw Operations Object</returns>
		RawOperation SignChangeKey(uint account, uint account_signer, string old_enc_pubkey, string old_b58_pubkey, string new_enc_pubkey, string new_b58_pubkey, uint last_n_operation, decimal fee, byte[] payload = null, PayloadEncryptionMethod ? payloadMethod = null, string pwd = null, string rawoperations = null);
		...
		/// <remarks>Only one or none of signer_b58_pubkey, signer_b58_pubkey should be used. Populating both will result in an error.</remarks>
		/// <returns>Returns a Raw Operations Object</returns>
		RawOperation SignDelistAccountForSale(uint account_target, uint account_signer, uint last_n_operation, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null, string signer_b58_pubkey = null, string signer_enc_pubkey = null, string rawoperations = null);
		...
		Operation[] OperationsInfo(string rawoperations);
		...
		Operation[] ExecuteOperations(string rawoperations);
		...
		/// <remarks>Note: If use enc_pubkey and b58_pubkey together and is not the same public key, will return an error</remarks>
		/// <returns>Returns a JSON Object with a "Public Key Object"</returns>
		PublicKey DecodePubKey(string enc_pubkey, string b58_pubkey);
		...
		DecryptedPayload PayloadDecrypt(string payload, string[] pwds = null);
		...
		/// <returns></returns>
		PublicKey AddNewKey(KeyType ec_nid, string name);
		...
		SignResult SignMessage(string digest, string b58_pubkey, string enc_pubkey);
		...
		SignResult VerifySign(string digest, string enc_pubkey, string signature);
		...
		/// <returns></returns>
		RawMultiOperation MultiOperationAdd(string rawoperations, bool auto_n_operation, Sender[] senders, Receiver[] receivers, Changer[] changesinfo);
		...
		RawMultiOperation MultiOperationSignOffline(string rawoperations, AccountKey[] signers);
		...
		/// <returns>If success will return a "MultiOperation Object"</returns>
		RawMultiOperation MultiOperationSignOnline(string rawoperations);
		...
		/// <returns>If success will return a "MultiOperation Object"</returns>
		RawMultiOperation MultiOperationDeleteOperation(string rawoperations, int index);
