...
namespace NPascalCoin {
	public static class PascalCoinClientExtensions {
		...
		public static Task<Block> GetBlockAsync(this IPascalCoinClient client, uint block) {
		...
		public static Task<Operation> GetBlockOperationAsync(this IPascalCoinClient client, uint block, uint opblock) {
		...
		public static Task<Operation[]> GetBlockOperationsAsync(this IPascalCoinClient client, uint block, int? start = null, int? max = null) {
		...
		public static Task<Operation[]> GetPendingsAsync(this IPascalCoinClient client, int? start = null, int? max = null) {
		...
		public static Task<Operation> ChangeAccountInfoAsync(this IPascalCoinClient client, uint account_target, uint account_signer, string new_enc_pubkey, string new_b58_pubkey, string new_name, ushort? new_type, decimal fee, byte[] payload = null, PayloadEncryptionMethod? payloadMethod = null, string pwd = null) {
		...
		public static Task<RawMultiOperation> MultiOperationSignOfflineAsync(this IPascalCoinClient client, string rawoperations, AccountKey[] signers) {
			return Task.Run(() => client.MultiOperationSignOffline(rawoperations, signers));
		}

		public static Task<RawMultiOperation> MultiOperationSignOnlineAsync(this IPascalCoinClient client, string rawoperations) {
			return Task.Run(() => client.MultiOperationSignOnline(rawoperations));
		}

		public static Task<RawMultiOperation> MultiOperationDeleteOperationAsync(this IPascalCoinClient client, string rawoperations, int index) {
